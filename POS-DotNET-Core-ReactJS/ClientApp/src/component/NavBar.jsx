...
export default function NavBar(){
    useEffect(() => {
        if((Number(sessionStorage.getItem("userID")) > null) || (sessionStorage.getItem("userID") === undefined)){
            sessionStorage.setItem('userID', 0);
        }
        if((Number(sessionStorage.getItem("userName")) > null) || (sessionStorage.getItem("userName") === undefined)){
            sessionStorage.setItem('userID', 0);
        }
        if((Number(sessionStorage.getItem("type")) > null) || (sessionStorage.getItem("type") === undefined)){
